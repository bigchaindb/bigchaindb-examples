...
const fbPlugin = require('ilp-plugin-bells');
...
// sender.connect().catch((err) => console.log(err));
// receiver.connect().catch((err) => console.log(err));
//
...
//
//     sender.quote({
//         destinationAddress: payment.destinationLedger,
