...
from tokens.accounts import Account
from tokens.util import take_at_least_seconds, create_asset, create_asset_hashlock

bigchain = bigchaindb.Bigchain()


def main():
    organizer = Account(bigchain=bigchain, name='organizer')
    capacity = 10
    payload = {
    ...
    with take_at_least_seconds(8):
        customers = [Account(bigchain=bigchain,
